...
$(document).on("click", ".userCommentsButton", function(event) {
      ...
      newComments = this.parentNode.childNodes[1].childNodes[1].value; //button.div.form.textarea.value
...
function loadUserData() {
    database.ref().on("child_added", function(childSnapshot, prevChildKey){
        ...
        if (localUser == logEmail ) {
            ...
            photoImage.attr("dbKey", dbRefKey);
            locations = childSnapshot.val().locations;

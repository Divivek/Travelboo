...
database.ref().on("child_added", function(childSnapshot, prevChildKey){
   ...
   // var column = $("<div class='col-sm-3 col-md-3'");
    ...
    var commentForm = $('<form class="form-group" action=""><label for="comment">Comment:</label><textarea class="form-control" rows="5" id="textArea">' + commentData + '</textarea><button type="submit" id="addData" value="Submit">Submit Comment</button></form>')
